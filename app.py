...
app.layout = html.Div(children=[
        ...
        dbc.Row([
            dbc.Col([      
                dbc.Card([
                    html.H2("FlexxTech Analyics", style={"font-family": "Voltaire", "font-size": "17px", "text-align": "center"}),
                    html.H2("Solutione", style={"font-family": "Voltaire", "font-size": "17px", "text-align": "center"}),
                    html.Hr(),

                    html.H5("Cidades"),
                    dcc.Checklist(df_data["City"].value_counts().index,
                    df_data["City"].value_counts().index, id="check-city",
                    inputStyle={"margin-right":"5px","margin-left":"20px"}),

                    html.H5("Variavel de análise", style={"margin-top":"30px"}),
